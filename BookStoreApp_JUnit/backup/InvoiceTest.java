...
public class InvoiceTest {
	...
	public void testAddBook() {
		strBuilder.append("\n\n===== ADD Book to Invoice =====\n");
		try {
			invoice.addBook("Book 1", 1.0, 20.0);
		} catch (Exception e) {
			e.printStackTrace();
		}
		strBuilder.append("\n> GET Total: ");
